...
@SpireInitializer
public class HandSonicVer4 extends AbstractAngelPlayerCards{

    public static final String ID = "HandSonicVer4";
...
//    public static final String UPGRADE_DESCRIPTION;
    ...
    public HandSonicVer4() {
        super(ID, HandSonicVer4.NAME, COST, HandSonicVer4.DESCRIPTION, CardType.ATTACK, CardRarity.RARE, CardTarget.ENEMY);
...
//            this.rawDescription = UPGRADE_DESCRIPTION;
    ...
    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("HandSonicVer4");
        NAME = HandSonicVer4.cardStrings.NAME;
        DESCRIPTION = HandSonicVer4.cardStrings.DESCRIPTION;
//        UPGRADE_DESCRIPTION = HandSonicVer4.cardStrings.UPGRADE_DESCRIPTION;
    }
}
