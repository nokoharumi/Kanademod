...
@SpireInitializer
public class HandSonicVer5 extends AbstractAngelPlayerCards{

    public static final String ID = "HandSonicVer5";
...
//    public static final String UPGRADE_DESCRIPTION;
    ...
    public HandSonicVer5() {
        super(ID, HandSonicVer5.NAME, COST, HandSonicVer5.DESCRIPTION, CardType.POWER, CardRarity.RARE, CardTarget.ENEMY);
...
//        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(player, player, new SonicVer1Power(player, monster, this.magicNumber), this.magicNumber));
    ...
    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("HandSonicVer5");
        NAME = HandSonicVer5.cardStrings.NAME;
        DESCRIPTION = HandSonicVer5.cardStrings.DESCRIPTION;
